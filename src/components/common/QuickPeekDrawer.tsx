  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Xem nhanh chi tiết ghi chú"
      ...
      >
        ...
        <div className="p-4 border-b border-surface-border flex items-center justify-between bg-surface-hover/30">
          <div className="flex items-center gap-2">
            {note.isPrivate ? (
              <span className="flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded bg-amber-500/15 text-amber-400 border border-amber-500/30">
                <Lock className="h-3 w-3" /> Ghi chú Riêng tư
              </span>
            ) : (
