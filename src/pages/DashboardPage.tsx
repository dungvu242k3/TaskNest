    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-200">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-900/40 via-surface to-surface border border-indigo-500/20 p-8">
        <div className="relative z-10 max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-semibold mb-3">
            <Sparkles className="h-3.5 w-3.5" /> Team Workspace Overview
          </div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight leading-tight">
            Welcome back, Alex 👋
          </h1>
          <p className="text-slate-300 text-sm mt-2 leading-relaxed">
            You have <span className="text-indigo-400 font-semibold">{privateNotes.length} private notes</span> and{' '}
            <span className="text-amber-400 font-semibold">{sharedNotes.length} shared team notes</span> active in your workspace.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="glass-panel glass-panel-hover p-5 rounded-2xl flex items-center justify-between">
          <div>
            <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Notes</span>
            <div className="text-2xl font-bold text-white mt-1">{notes.length}</div>
            <p className="text-[11px] text-slate-400 mt-1">Across 5 team members</p>
          </div>
        ...
        <div className="glass-panel glass-panel-hover p-5 rounded-2xl flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-1">Checklist items resolved</p>
          </div>
        ...
        <div className="glass-panel glass-panel-hover p-5 rounded-2xl flex items-center justify-between">
          <div>
            <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Shared Collaborations</span>
            <div className="text-2xl font-bold text-amber-400 mt-1">{sharedNotes.length}</div>
            <p className="text-[11px] text-slate-400 mt-1">Active team notes</p>
          </div>
